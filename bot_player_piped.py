'''
play a bot script from stdin
for static commands stored in files
usage: cat path/to/commandfile.txt | python bot_player_piped.py ...
for dynamic commands generated on the fly
usage: python path/to/commandgenerator.py ... | python bot_player_piped.py ...
'''
...
def main(args):
    with BotPlayer(args.device) as player:
...
if __name__ == "__main__":
    ...
    parser = ArgumentParser(
        description='''play a bot script from stdin.
        for static commands stored in files
        usage: cat path/to/commandfile.txt | python bot_player_piped.py ...
        for dynamic commands generated on the fly
        usage: python path/to/commandgenerator.py ... | python bot_player_piped.py ...
